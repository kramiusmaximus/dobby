...
def test_telegram_client_sends_html_parse_mode(monkeypatch):
    ...
    monkeypatch.setattr("dobby_app.integrations.telegram.settings.telegram_user_id", 123)
    monkeypatch.setattr("dobby_app.integrations.telegram.get_bot", lambda: FakeBot())

...
from dobby_app.services.memory_notes import delete_memory_line, sync_calendar_item_to_memory, update_memory_line
...
def test_delete_memory_line_refuses_ambiguous_line(monkeypatch):
    ...
    monkeypatch.setattr("dobby_app.services.memory_notes.obsidian_is_enabled", lambda: True)
    monkeypatch.setattr("dobby_app.services.memory_notes.get_obsidian_client", lambda: FakeObsidianClient())

...
from dobby_app.integrations.obsidian import ObsidianClient, ObsidianConfig
...
def test_obsidian_client_read_sends_auth_and_tls(monkeypatch):
    ...
    monkeypatch.setattr("dobby_app.integrations.obsidian.httpx.request", fake_request)
